    ...
    <div className="min-h-screen animated-gradient flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">Join Neural Cortex and build your AI twin</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white text-gray-900 font-semibold hover:bg-gray-100 transition-colors"
        >
        ...
        <div className="mt-6 text-center">
          <p className="text-text-secondary text-sm">
            ...
            <Link href="/signin" className="text-neon-blue hover:text-neon-purple font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
